...
public:
	...
	/**set basket for the fruit
	* \param basket we are setting to*/
	void SetBasket(CActualBasket *basket){ mBasket = basket; }

protected:
	CActualBasket *mBasket = nullptr;	///< pointer to basket
	int mX = 0;							///< location of apple in basket
	int mY = 0;							///< location of apple in basket
};
