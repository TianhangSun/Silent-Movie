...
public:
    ...
    * \returns Iter object at position past the end */
	...
	/**save the seed in picture(XML)
	* \return the seed*/
	virtual int SaveSeed(){ return 0; }

	/**load the seed from picture(XML)
	* \param seed to load*/
	virtual void LoadSeed(int seed){}

	/**set harvest frame
	* \param frame we're setting*/
	virtual void SetHarvestFrame(int frame){}

	/**get harvest frame
	* \returns harvest frame*/
	virtual int GetHarvestFrame(){ return 0; }
